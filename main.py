...
def start_training(char_name, char_class):
    ...
    print('defence — чтобы блокировать атаку противника или special — чтобы')
    print('использовать свою суперсилу.')
...
def choice_char_class():
    ...
    while approve_choice != 'y':
        ...
        print('играть: Воитель — warrior, Маг — mage, Лекарь — healer: ')
        if char_class == 'warrior':
        ...
        if char_class == 'healer':
            ...
            print('природы, веры и духов.')
        approve_choice = input('Нажми (Y), чтобы подтвердить выбор, или любую')
        print('другую кнопку, чтобы выбрать другого персонажа ').lower()
    return char_class
